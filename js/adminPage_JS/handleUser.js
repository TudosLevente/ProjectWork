        ...
        for (let i = 1; i <= data.length; i++) {
            ...
            userDiv.innerHTML = `
              <div class="users-layout__input-layout">
                ...
                <input id="userName_${i}" readonly class="users-layout__name2" placeholder="Felhasználó név" value="${data[i - 1].Username}">
                <!-- <div class="users-layout__input2">Felhasználó név</div> -->
                <input id="userEmail_${i}" readonly class="users-layout__email" placeholder="Email cím" value="${data[i - 1].Email}">
                <!-- <div class="users-layout__input2">Email cím</div> -->
              </div>
              <div class="users-layout__button-layout">
                <button type="button" id="deleteBtn_${i}" onclick="deleteUser(this.id)" class="users-layout__delete-button">
                  <div class="users-layout__text">Törlés</div>
                </button>
                <button type="button" id="modifyBtn_${i}" onclick="modifyUser(this.id)" class="users-layout__modify-button">
