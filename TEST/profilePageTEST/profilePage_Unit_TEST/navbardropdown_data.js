// Import the showAdataim function
const { showAdataim } = require('./path/to/showAdataim');
...
// Test suite for the showAdataim function
describe('showAdataim', () => {
    ...
    test('should set styles and display properties correctly', () => {
        ...
        expect(document.getElementById("DataDivButton").style.backgroundColor).toBe("#ff9900");
